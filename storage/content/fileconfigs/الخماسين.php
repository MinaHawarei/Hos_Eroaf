...
class ContentService
{
        ...
        foreach ($fileConfigs as $configKey => $entry) {
            if (is_array($entry)) {
                ...
                foreach ($entry as $altConfig) {
                    if (!is_array($altConfig) || !isset($altConfig['file'])) {
                        continue;
                    }

                    $fileName = (string) $altConfig['file'];
                    $label = (string) ($altConfig['label'] ?? '');
    ...
    public function getLiturgy($data): ?array
    {
        ...
        $fileConfigs = [
            ...
            "sotis_amin"=>'سوتيس امين',
            "ne_saviv"=>'ني صافيف', //للاسقف
            "tahlil_alkhodam"=>'تحليل الخدام',
            "te_shory"=>'تي شوري', //طاي شوري
            "hetaniat" =>[
                ['file' => 'الهيتنيات', 'label' => 'الهيتنيات'],
                ['file' => 'الهيتنيات مجمعة',  'label' => 'الهيتنيات مجمعة'],
            ], // هيتنيات الخماسين
            "be_ehmot_ghar"=>'بي اهموت غار الصغير', // للاسقف
            "pauline" => ['type' => 'lectionary'],
            "catholic" => ['type' => 'lectionary'],
            "marad_praxis"=>'شيري تيف انسطاسيس', // مرد البراكسيس
            "praxis" => ['type' => 'lectionary'],

            "katany_khoros"=>'كاطاني خوروس', /////////
            "oanem_nay"=>'اونيم ناي', ///////////
            "yakol_alsefof"=>'يا كل الصفوف', ////////////
            "ekhristos_alfabira"=>'اخرسيتوس الكبيرة', ////////////
            "ekhristos_alsaghira"=>'اخرسيتوس الصغيرة', ////////
            "toan_sina"=>'طون سينا', //////////
            "toalisos"=>'طوليثوس', //////////
            "tain_anastasin"=>'تين اناسطاسين', //////////
            "bikhristos_aftonf"=>'بخريستوس افطونف', //////////



            "mohaier_batshoais"=>'محير باتشويس', //////////
            "agyous"=>'اجيوس',
            "oshait_al_angeal"=>'اوشية الانجيل',
            "maro_etshasf"=>'مارو اتشاسف', //للاسقف
            "marad_almazmor"=>'مرد المزمور', //////////
            "liturgy_psalm" => ['type' => 'lectionary'],
            "liturgy_gospel" => ['type' => 'lectionary'],
            "marad_alangel"=>'مرد انجيل الخماسين', //////////
            ...
            "esbasmos_adam" => [
                ['file' => 'بخريستوس بينوتي', 'label' => 'اسبسمس ادام'],
                ['file' => 'مارين هوس', 'label' => 'اسبسمس ادام الثاني'],
                ['file' => 'ابينشويس ايسوس', 'label' => 'اسبسمس ادام الثالث'],
            ], ////
            ...
            "el_qisma" => [
                ['file' => 'قسمة القيامة', 'label' => 'قسمة القيامة'],
                ['file' => 'قسمة الخماسين', 'label' => 'قسمة الخماسين'],
            ], ////
